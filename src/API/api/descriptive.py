...
async def get_customers_signup(token: Annotated[str, Depends(is_token_valid)], last_days: int = 0, month: bool = False, year: bool = False, showzeros: bool = False, percentage: bool = False):
    ...
    **Returns:**
    - dict: The amount of customers and their percentage growth in relation to the previous period that signed up in the last days, month or year if percentage is True.
        Example: {
            "2023": [0, 100],
            "2024": [100.0, 200]
        }
    - dict: The amount of customers that signed up in the last days, month or year if percentage is False.
        Example: {
            "2023": 100,
            "2024": 200
        }
...
async def get_orders_amount(token: Annotated[str, Depends(is_token_valid)], last_days: int = 0, month: bool = False, year: bool = False, showzeros: bool = False, percentage: bool = False):
    ...
    **Returns:**
    - dict: The amount of orders and their percentage growth in relation to the previous period made in the last days, month or year if percentage is True.
        Example: {
            "2023": [0, 100],
            "2024": [100.0, 200]
        }
    - dict: The amount of orders made in the last days, month or year if percentage is False.
        Example: {
            "2023": 100,
            "2024": 200
        }
